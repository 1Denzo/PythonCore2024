with open('Home_Made\LR2\Task2\FileIO\input.txt', 'r', encoding='utf-8') as f: 
    ...
    w = open('Home_Made\LR2\Task2\FileIO\output.txt', 'w', encoding='utf-8')  # открытие в режиме записи
